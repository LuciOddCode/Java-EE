...
<%@ page import="lk.ijse.jsp.servlet.CustomerServlet" %><%--
    ...
    <section class="row">
            ...
            <div class="col-12 col-lg-4">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="txtCustomerID" name="cusID" required type="text">
                ...
                <div class="btn-group">
                    <button name="press" value="save" type="submit" formaction="customer" formmethod="post" class="btn btn-primary" id="btnCustomer">Save Customer</button>
                    <button name="press" value="delete" type="submit"  formaction="customer" formmethod="post" class="btn btn-danger" id="btnCusDelete">Remove</button>
                    <button name="press" value="update" type="submit" formaction="customer" formmethod="post"  class="btn btn-warning" id="btnUpdate">Update</button>
                    <button name="press" value="getAll" type="submit" class="btn btn-success" id="btnGetAll">Get All</button>
        ...
        <%
            ...
            ArrayList<CustomerDTO> allCustomers = customerServlet.getAll();
        %>
